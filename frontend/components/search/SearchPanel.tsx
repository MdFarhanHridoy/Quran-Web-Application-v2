...
export default function SearchPanel({ isOpen, onClose, onSearch }: SearchPanelProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full max-w-2xl bg-[#171717] rounded-xl border border-[#212121] shadow-2xl p-6 transition-all duration-300 ${
          isOpen
      ...
      >
        <form onSubmit={handleSubmit} className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-2 hover:bg-[#1c1c1c] rounded-lg transition-colors text-[#7b7d7b] hover:text-[#c4c4c4] flex-shrink-0"
